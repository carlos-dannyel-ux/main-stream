            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-between gap-6 mb-8">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <a href="#" className="p-2 text-gray-400 hover:text-white transition-colors" aria-label="Twitter">
                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6 mb-8">
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><Link href="/filmes" className="text-gray-400 hover:text-white text-sm transition-colors">Filmes</Link></li>
                            <li><Link href="/series" className="text-gray-400 hover:text-white text-sm transition-colors">Séries</Link></li>
                        </ul>
                    </div>
                    <div>
