            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-12 relative z-10">
                <div className="mb-12">
                    <Suspense fallback={
                        ...
                        <StreamPlayer id={movieId} type="movie" />
                    </Suspense>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                    ...
                    <div className="space-y-6">
                        ...
                        <div>
                            <h3 className="text-gray-500 text-sm font-bold uppercase tracking-wider mb-2">Orçamento</h3>
                            <p className="text-white">
                                {movie.budget > 0 ? `$${movie.budget.toLocaleString()}` : 'Não informado'}
                            </p>
                        </div>
                        <div>
                            <h3 className="text-gray-500 text-sm font-bold uppercase tracking-wider mb-2">Receita</h3>
                            <p className="text-white">
                                {movie.revenue > 0 ? `$${movie.revenue.toLocaleString()}` : 'Não informado'}
                            </p>
                        </div>
                        <div>
